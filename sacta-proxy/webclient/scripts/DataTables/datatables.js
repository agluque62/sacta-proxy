 ...
 *   https://datatables.net/download/#bs/dt-1.10.23/fc-3.3.2/sb-1.0.1/sp-1.2.2
 *
 * Included libraries:
 *   DataTables 1.10.23, FixedColumns 3.3.2, SearchBuilder 1.0.1, SearchPanes 1.2.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.23/fc-3.3.2/sb-1.0.1/sp-1.2.2",
